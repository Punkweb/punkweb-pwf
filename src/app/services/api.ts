...
class Endpoint {
  ...
  read(id: number | string, params: any = null) {
    return pwf.request({
      method: 'GET',
  ...
  update(id: number | string, data: any = null, put = false) {
    let method = null;
    if (put) {
      method = 'PUT';
    } else {
  ...
  listRoute(method: string, route: string, data: any = null, params: any = null) {
    return pwf.request({
      method,
  ...
  detailRoute(method: string, route: string, id: number | string, data: any = null, params: any = null) {
    return pwf.request({
      method,
  ...
  createUrl(id: number | string = null) {
    if (id) {
